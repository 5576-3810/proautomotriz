...
namespace Automotriz.Controllers
{
    public class REPUESTOesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID_REPUESTO,NOMBRE,DESCRIPCION,ESTADO,PRECIO,DETALLE")] REPUESTO rEPUESTO)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID_REPUESTO,NOMBRE,DESCRIPCION,ESTADO,PRECIO,DETALLE")] REPUESTO rEPUESTO)
        {
            if (ModelState.IsValid)
            {
